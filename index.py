...
def create_pg():
    ...
    "my_html/images/banners/india.jpg",
    headlines_gnews(),
    'india.html'],
    ["World",
    ...
    "my_html/images/banners/world.jpg",
    world_gnews(),
    'world.html'],
    ['Business',
    'ALBERT EINSTEIN ONCE SAID �COMPOUND INTEREST IS THE EIGHTH WONDER OF THE WORLD.',
    'my_html/images/banners/business.jpeg',
    business_gnews(),
    'business.html'],
    ['Techies',
    "IT'S NOT A FAITH IN TECHNOLOGY. IT'S FAITH IN PEOPLE.",
    "my_html/images/banners/tech.jpg",
    tech(),
    'tech.html'],
    ["Health",
    "GIVE A MAN HEALTH AND A COURSE TO STEER, AND HE�LL NEVER STOP TO TROUBLE ABOUT WHETHER HE�S HAPPY OR NOT.",
    "my_html/images/banners/med.jpg",
    health_gnews(),
    "health.html"]]
    index_create()
